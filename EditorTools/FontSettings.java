...
public class FontSettings
{
    ...
    public FontSettings(JFrame frame,JTextArea mytextarea)
    {
            this.mytextarea=mytextarea;
            font1=mytextarea.getFont();
            fd=new JFontChooser(frame,mytextarea.getFont());        
    }
    public void fontset()
    {
            fd.show();
            ...
            {
                font1 = fd.getFont();
                mytextarea.setFont(fd.getFont());
            }
            fd.dispose();
    }
}

class JFontChooser extends javax.swing.JDialog {
    ...
    JFontChooser(java.awt.Frame parent, Font font) {
        super(parent);
        this.font = font;
        initComponents();
    ...
    JFontChooser(java.awt.Frame parent) {
        super(parent);
